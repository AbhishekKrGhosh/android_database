...
class RoomDBActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        listView.setOnItemLongClickListener { parent, view, position, id ->
            ...
            val id = view.findViewById<TextView>(R.id.idIn).text.toString().toLong()
            val name= view.findViewById<TextView>(R.id.nameIn).text.toString()
            val phone=view.findViewById<TextView>(R.id.phoneId).text.toString().toLong()
